...
function showDetails_k1r(event){
...
/* remove current html */
  			var allProducts = document.getElementById('goods_show_k1r');
  			allProducts.remove();
...
<div id='${sku}' class='sku'>
	...
	<div class='mb-4 px-5 latte_bg banner container-fluid d-none d-md-block d-lg-block d-xl-block d-xxl-block'>
		<div class="d-flex justify-content-evenly">
			...
			<div class="mt-3 d-flex justify-content-between">
				<a class='' href='#'>
					<button class='to-order white btn-prod-card' onClick='pushSKUinForm_k1r(event);'>
						Заказать
					</button>
				</a>
				<a class='white' href='#'>
	...
	<div class=' mt-2 d-block d-md-none'>
		...
		<div class="d-flex justify-content-around white btn-prod-card my-2 img-cover">
				<a class='to-order white p-2' onClick='pushSKUinForm_k1r(event);'>
					Заказать
				</a>
