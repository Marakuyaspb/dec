...
/* get SKU of product by the CLICK */
	...
	var buttons = document.querySelectorAll('.product_card');
	Array.from(buttons).forEach(function(button){
      	button.addEventListener('click', function(e) {
      	var currentProductCard = e.target.id;
    	console.log(currentProductCard);
   
/* compare the clicked SKU with all SKUs in [] */

    var currentSKU = currentProductCard.sku;
...
/* render new html about the single product */
	  		var divDeteails = document.getElementById('sofa_details');
	  		divDeteails.innerHTML(productAllDetails) +=
