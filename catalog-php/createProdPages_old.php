...
<div id='$row[sku]' class='sku'>
    ...
    <div class='container-fluid mt-4 d-none d-md-block d-lg-block d-xl-block d-xxl-block'>
        ...
        <div class='row'>
            <div class='col-md-8'>
                <p class='h-center'>$row[product_name]</p>
                <center>
                <p class='fabric-name pt-4'>Ткань: $row[fabric_name]
                </center>
            <!-- fabric buttons -->
                <div class='slide-fabric-nav' onClick ='event.stopPropagation()'>     
                    <img class='slide-fabric-button fabric-var' id='$row[model]_jazz_01' src='http://decona.ru/p-content/uploads/goods_pics/FABRIC/JAZZ/ICONS/JAZZ_01.png' onClick ='showDetailsByFabric(event);'>
                
                    <img class='slide-fabric-button fabric-var' id='$row[model]_jazz_21' src='http://decona.ru/p-content/uploads/goods_pics/FABRIC/JAZZ/ICONS/JAZZ_21.png' onClick ='showDetailsByFabric(event);'>
                
                    <img class='slide-fabric-button fabric-var' id='$row[model]_pixel_forest' src= 'http://decona.ru/p-content/uploads/goods_pics/FABRIC/PIXEL/ICONS/PIXEL_FOREST.png' onClick ='showDetailsByFabric(event);'>
                
                    <img class='slide-fabric-button fabric-var' id='$row[model]_cambridge_600' src='http://decona.ru/p-content/uploads/goods_pics/FABRIC/CAMBRIDGE/ICONS/CAMBRIDGE_600.png' onClick ='showDetailsByFabric(event);'>
                
                    <img class='slide-fabric-button fabric-var' id='$row[model]_velutto_32' src='http://decona.ru/p-content/uploads/goods_pics/FABRIC/JAZZ/ICONS/JAZZ_08.png' onClick ='showDetailsByFabric(event);'>
                </div>
                <div class='ms-4'>
                ...
                <div id='carouselExampleIndicators' class='carousel slide' data-bs-ride='carousel'>
                    ...
                    <div class='carousel-inner'>
                        <div class='carousel-item active'>
                            <img src='$row[carousel_item_1]' class='d-block w-100' alt='...'>
                        </div>
                        <div class='carousel-item'>
                            <img src='$row[carousel_item_2]' class='d-block w-100' alt='...'>
                        </div>
                        <div class='carousel-item'>
                            <img src='$row[carousel_item_3]' class='d-block w-100' alt='...'>
                        </div>
                        <div class='carousel-item'>
                            <img src='$row[carousel_item_4]' class='d-block w-100' alt='...'>
                        </div>
                        <div class='carousel-item'>
                            <img src='$row[carousel_item_5]' class='d-block w-100' alt='...'>
                        </div>
                    </div>
            ...
            <div class='col-md-4 no-padding-right'>
                <img class='img-fluid banner' src='$row[right_sofa_piece]'>
            </div>
        </div>
    </div>
    ...
    <div class='container-fluid mt-5 d-block d-md-none'>
        ...
        <div class='slide-fabric-nav' onClick ='event.stopPropagation()'>     
            <img class='slide-fabric-button fabric-var' id='$row[model]_jazz_01' src='http://decona.ru/wp-content/uploads/2023/02/Jazz-01-copy-1.png' onClick ='showDetailsByFabric(event);'>
        
            <img class='slide-fabric-button fabric-var' id='$row[model]_jazz_08'src='http://decona.ru/wp-content/uploads/2023/02/Jazz-08-copy-1.png' onClick ='showDetailsByFabric(event);'>
        
            <img class='slide-fabric-button fabric-var' id='$row[model]_jazz_21' src= 'http://decona.ru/wp-content/uploads/2023/02/Jazz-21-copy-1.png' onClick ='showDetailsByFabric'>
        
            <img class='slide-fabric-button fabric-var' id='$row[model]_velutto_16' src='http://decona.ru/wp-content/uploads/2023/02/VElutto-16-1.png' onClick ='showDetailsByFabric(event);'>
        
            <img class='slide-fabric-button fabric-var' id='$row[model]_velutto_32' src='http://decona.ru/wp-content/uploads/2023/02/VElutto-32-copy-1.png' onClick ='showDetailsByFabric(event);'>    
        </div>
    ...
    <div class='mb-4 px-5 latte_bg banner container-fluid d-none d-md-block d-lg-block d-xl-block d-xxl-block'>
        <div class='d-flex justify-content-evenly'>
            <div class='mt-2 prod-card-model'>$row[product_full_name]</div>
            <div class='mt-1'>
                <p class='prod-card-price'>$row[price_sale]</p>
                <p class='old-price'>$row[price]</p>
            </div>
    ...
    <div class=' mt-2 d-block d-md-none'>
        <div class='ps-3'>$row[product_full_name]</div>
        <div class='mt-1'>
                <p class='prod-card-price'>$row[price_sale]</p>
                <p class='old-price'>$row[price]</p>
            </div>
                                ...
                                <div class='col-md-4 col-sm-12'>
                                    <table class='prod-card-table'>
                                        <tr class='prod-card-table-row'>
                                            ...
                                            <td>
                                                <p id='prod_width'>$row[prod_width]
                                            </td>
                                        </tr>
                                        <tr class='prod-card-table-row'>
                                            <td>
                                            ...
                                            <td>
                                                <p id='prod_depth'>$row[prod_depth]
                                            </td>
                                        </tr>
                                        <tr class='prod-card-table-row'>
                                            <td>
                                            ...
                                            <td>
                                                <p id='prod_height'>$row[prod_height]
                                            </td>
                                        </tr>
                                        <tr class='prod-card-table-row'>
                                            <td>
                                            ...
                                            <td>
                                                <p id='prod_weight'>$row[prod_weight]
                                            </td>
                                        </tr>
                                        <tr class='prod-card-table-row'>
                                            <td>
                                            ...
                                            <td>
                                                <p id='prod_seat_height'>$row[prod_seat_height]
                                            </td>
                                        </tr>
                                        <tr class='prod-card-table-row'>
                                            ...
                                            <td>
                                                <p id='prod_seat_width'>$row[prod_seat_width]
                                            </td>
                                        </tr>
                                        <tr class='prod-card-table-row'>
                                            <td>
                                            ...
                                            <td>
                                                <p id='prod_seat_depth'>$row[prod_seat_depth]
                                            </td>
                                        </tr>
                                        <tr class='prod-card-table-row'>
                                            <td>
                                            ...
                                            <td>
                                                <p id='prod_back_width'>$row[prod_back_width]
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class='col-md-6 col-sm-12'>
                                    <table class='prod-card-table'>
                                        <tr>
                                            ...
                                            <td>
                                                <p class='text-end'>$row[product_type]
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <p class='text-end'>$row[transform_type]
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <p class='text-end'>$row[matress_type]
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                <div class='col-md-6 col-sm-12'>
                                    <table class='prod-card-table'>
                                        <tr>
                                            ...
                                            <td>
                                                <p class='text-end'>$row[product_form]
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <p class='text-end'>$row[product_style]
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <p class='text-end'>$row[product_inside]
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                <p>Конструктивные особенности: $row[features]
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class='accordion-body'>
                        <div class='container-fluid'>
                            <div class='row'>
                                ...
                                <div class='col-md-4 col-sm-12'>
                                    <img src='$row[product_fabric_img]' class='img-fluid'>
                                </div>
                            </div>  
                        </div>
                    </div>
...
get_footer();
";
$dir = 'wp-content/uploads/catalog/';
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $filename = $dir . $sku . '.php';
    $content = sprintf($template, $sku, $category);
