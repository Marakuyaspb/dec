...
<div class='container-fluid mt-2 d-none d-md-block d-lg-block d-xl-block d-xxl-block' id='goods_categories_desctop'>
	<div class='row'>
		<div class="col-md-6 col-sm-12 py-1 row_prod_catgories" id="k1r_FILTER_IT" onclick="filterProducts(event);">
	  	...
	  	<div class="col-md-6 col-sm-12 py-1 row_prod_catgories" id="corner_FILTER_IT" onclick="filterProducts(event);">
	  		<div class='latte_wrap my-2  p-4'>
	...
	<div class='row '>
		<div class="col-md-6 col-sm-12 py-1 row_prod_catgories" id="str_FILTER_IT" onclick="filterProducts(event);">
			<div class='latte_wrap my-2 p-4'>
				<!-- a href='#' -->
					<div class ='category_label'>
	...
	<div class='row'>
		<div class="col-md-6 col-sm-12 py-1 row_prod_catgories" id="bed_FILTER_IT" onclick="filterProducts(event);">
			<div class='latte_wrap my-2 p-4'>
				<!-- a href='#' -->
					<div class ='category_label'>
	...
	<div class='row'>
		<div class="col-md-6 col-sm-12 py-1 row_prod_catgories" id="pouf_FILTER_IT" onclick="filterProducts(event);">
			<div class='latte_wrap my-2 p-4'>
	...
	<div class='my-5 mx-4 d-none d-lg-block d-xl-block d-xxl-block' id='desctop-show'>
		<div class='d-flex justify-content-between'>
			<div class ='rectangle latte_bg ps-4'> <!-- #F6F1EE -->
				<h2 class='rect-card ps-4 h2_w600'>Каталог</h2>
				<h2 class='ps-4 mb-5 h2_w600'>2023</h2>
			...
			<div class ='rectangle dark-gray ps-4'> <!-- #50504E -->
				<h2 class='white rect-card ps-4 h2_w600'>Покупка в рассрочку </h2>
				<h2 class='white ps-4  mb-5 h2_w600'>без первого взноса</h2>
			...
			<div class ='rectangle middle-gray ps-4'><!-- #CDCECF -->
					<h2 class='rect-card ms-4 h2_w600'>Все акции</h2>
					<h2 class='ms-4 mb-5 h2_w600'>и спецпредложения</h2>
		...
		<div class='row'>
			<div class ='col-md-4 rectangle_mob latte_bg'> <!-- #F6F1EE -->
				<div class='bottom-align'>
					<h4 class='rect-card ps-2 h2_w600'>Каталог с новинками 2023 года</h4>
			...
			<div class ='col-md-4 rectangle_mob dark-gray'> <!-- #50504E -->
				<div class='bottom-align'>
					<h4 class='white rect-card ps-4 h2_w600'>Покупка в рассрочку без первого взноса</h4>
			...
			<div class ='col-md-4 rectangle_mob middle-gray ps-4'><!-- #CDCECF -->
				<div class='bottom-align'>
					<h4 class='rect-card ps-2 h2_w600'>Все акции и спецпредложения</h4>
	...
	<div class='container-fluid pt-5 d-block d-sm-none' id='phone-show'>
		<div class='row'>
			...
			<div class ='col-md-4 rectangle_mob middle-gray ps-2'><!-- #CDCECF -->
				<div class='bottom-align'>
					<h3 class='rect-card ms-2 h2_w600'>Все акции и спецпредложения</h3>
