<?php
/*
Template name: portlandVelutto16
*/
	...
	<div class='container-fluid mt-4 d-none d-md-block d-lg-block d-xl-block d-xxl-block'>
		<div class='row'>
			<div class='col-md-8'>
				...
				<!-- slider with product -->
				    <div class='slide-fabric-nav'>  
						...
						<center>
			          	<p class='small pt-4'>Ткань: Velutto 16
			        	</center>
				    </div>
					...
					<div class="carousel-indicators">
				 	...
				 	<div class="carousel-inner">
					    <div class="carousel-item active">
					      <img src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-16_brandy_front-scaled.jpg" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-16_brandy_back-scaled.jpg" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-16_brandy_side-scaled.jpg" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-16_brandy_upclose-scaled.jpg" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-16_brandy_upopen-scaled.jpg" class="d-block w-100" alt="...">
					    </div>
					</div>
				</div>    
			</div>
			...
			<div class='col-md-4 no-padding-right'>
				<img class='img-fluid banner' src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-16_brandy_close_2.jpg">
			</div>
		</div>
	</div>
