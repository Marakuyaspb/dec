...
function twenty_twenty_one_get_non_latin_css( $type = 'front-end' ) {
	...
	$font_family = apply_filters(
		...
		array(
			...
			// Arabic.
			'ar'    => array( 'ALS Hauss Hairline', 'Tahoma', 'Arial', 'sans-serif' ),
			'ary'   => array( 'ALS Hauss Hairline','Tahoma', 'Arial', 'sans-serif' ),
			'azb'   => array( 'ALS Hauss Hairline','Tahoma', 'Arial', 'sans-serif' ),
			'ckb'   => array( 'ALS Hauss Hairline','Tahoma', 'Arial', 'sans-serif' ),
			'fa-IR' => array( 'ALS Hauss Hairline','Tahoma', 'Arial', 'sans-serif' ),
			'haz'   => array( 'ALS Hauss Hairline','Tahoma', 'Arial', 'sans-serif' ),
			'ps'    => array( 'ALS Hauss Hairline','Tahoma', 'Arial', 'sans-serif' ),
			...
			// Cyrillic.
			'bel'   => array( '\'ALS Hauss\'', 'Helvetica', '\'Segoe UI\'', 'Arial', 'sans-serif' ),
			'bg-BG' => array( '\'ALS Hauss\'', 'Helvetica', '\'Segoe UI\'', 'Arial', 'sans-serif' ),
			'kk'    => array( '\'ALS Hauss\'', 'Helvetica', '\'Segoe UI\'', 'Arial', 'sans-serif' ),
			'mk-MK' => array( '\'ALS Hauss\'', 'Helvetica', '\'Segoe UI\'', 'Arial', 'sans-serif' ),
			'mn'    => array( '\'ALS Hauss\'', 'Helvetica', '\'Segoe UI\'', 'Arial', 'sans-serif' ),
			'ru-RU' => array( '\'ALS Hauss\'', 'Helvetica', '\'Segoe UI\'', 'Arial', 'sans-serif' ),
			'sah'   => array( '\'ALS Hauss\'', 'Helvetica', '\'Segoe UI\'', 'Arial', 'sans-serif' ),
			'sr-RS' => array( '\'ALS Hauss\'', 'Helvetica', '\'Segoe UI\'', 'Arial', 'sans-serif' ),
			'tt-RU' => array( '\'ALS Hauss\'', 'Helvetica', '\'Segoe UI\'', 'Arial', 'sans-serif' ),
			'uk'    => array( '\'ALS Hauss\'', 'Helvetica', '\'Segoe UI\'', 'Arial', 'sans-serif' ),
			...
			// Greek.
			'el'    => array( '\'ALS Hauss Hairline\', Helvetica, Arial, sans-serif' ),
