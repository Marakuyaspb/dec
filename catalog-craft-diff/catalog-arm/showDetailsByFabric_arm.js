/* Change it! */
function showDetailsByFabric_arm(event){
...
/* compare the clicked SKU with all SKUs in [] */
   	for (let i = 0; i < CATALOG_ARM.length; ++i) {
	  	if (CATALOG_ARM[i].sku == currentSKU){
...
/* render new html about the single product */
  		...
  		anotherProduct.id = 'goods_details_arm';
  		let placeHere = document.getElementById('spinner_arm');
