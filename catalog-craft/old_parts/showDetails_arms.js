...
function showDetailsArms(event){
...
/* remove current html */
  			var allProducts = document.getElementById('arms-show');
  			allProducts.remove();
...
/* render new html about the single product */
  			document.getElementById('arms_details').innerHTML = 
			`
			<div id='${sku}' class='sku'>
				...
				<div class='slide-fabric-nav' onClick ='event.stopPropagation()'>  	  
			    	<img class='slide-fabric-button fabric-var' id='${model}_jazz_01' src="http://decona.ru/wp-content/uploads/2023/02/Jazz-01-copy-1.png" onClick ='showDetailsByFabric_arms(event);'>
					
				    	<img class='slide-fabric-button fabric-var' id='${model}_jazz_21'src='http://decona.ru/wp-content/uploads/2023/02/Jazz-08-copy-1.png' onClick ='showDetailsByFabric_arms(event);'>
				    
				    	<img class='slide-fabric-button fabric-var' id='${model}_cambridge_600' src= "http://decona.ru/wp-content/uploads/2023/02/Jazz-21-copy-1.png" onClick ='showDetailsByFabric_arms(event);'>
				    
				    	<img class='slide-fabric-button fabric-var' id='${model}_pixel_forest' src="http://decona.ru/wp-content/uploads/2023/02/VElutto-16-1.png" onClick ='showDetailsByFabric_arms(event);'>
				    
					    <img class='slide-fabric-button fabric-var' id='${model}_velutto_32' src="http://decona.ru/wp-content/uploads/2023/02/VElutto-32-copy-1.png" onClick ='showDetailsByFabric_arms(event);'>
