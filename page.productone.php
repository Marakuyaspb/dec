								...
								<div class='col-md-6 col-sm-12'>
									<table class='prod-card-table'>
										<tr>
											...
											<td>
												<p class='text-end' id='product_type'>Диван-кровать, Прямой диван
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<p class='text-end' id='transform_type'>Еврокнижка
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<p class='text-end' id='matress_type'>Пружины "змейка"
											</td>
										</tr>
									</table>
								</div>
								<div class='col-md-6 col-sm-12'>
									<table class='prod-card-table'>
										<tr>
											...
											<td>
												<p class='text-end' id='product_form'>Прямой
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<p class='text-end' id='product_style'>Современная классика
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<p class='text-end' id='product_inside'>Пенополиуретан, Холлкон, Войлок, Спанбонд
											</td>
										</tr>
									</table>
								</div>
								<p id='features'>Конструктивные особенности: Ящик для белья, Короб для хранения, Съемные подушки, Ортопедические свойства
							</div>
						</div>
		        	</div>
		    	</div>
