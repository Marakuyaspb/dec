<?php
/*
Template name: portlandVelutto32
*/
	...
	<div class='container-fluid mt-4 d-none d-md-block d-lg-block d-xl-block d-xxl-block'>
		<div class='row'>
			<div class='col-md-8'>
				...
				<!-- slider with product -->
				    <div class='slide-fabric-nav'>  
						...
						<center>
			          	<p class='small pt-4'>Ткань: Velutto 32
			        	</center>
				    </div>
					...
					<div class="carousel-indicators">
				 	...
				 	<div class="carousel-inner">
					    <div class="carousel-item active">
					      <img src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-32_black_front-scaled.jpg" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-32_black_back-scaled.jpg" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-32_black_side-scaled.jpg" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-32_black_upclose-scaled.jpg" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-32_black_upopen-scaled.jpg" class="d-block w-100" alt="...">
					    </div>
					</div>
				</div>    
			</div>
			...
			<div class='col-md-4 no-padding-right'>
				<img class='img-fluid banner' src="http://decona.ru/wp-content/uploads/2023/03/Portland_Velutto-32_black_close_2-copy.jpg">
			</div>
		</div>
	</div>
...
<!-- Desktop -->
	<div class='mb-4 py-2 px-5 latte_bg banner container-fluid d-none d-md-block d-lg-block d-xl-block d-xxl-block'>
		<div class="d-flex justify-content-evenly">
			<div class='prod-card-model'>Прямой диван Portland</div>
			<div class='prod-card-price'>95 565 ₽</div>
