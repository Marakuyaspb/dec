/* Change it! */
function showDetailsByFabric_k1r(event){
...
/* compare the clicked SKU with all SKUs in [] */
   	for (let i = 0; i < CATALOG_K1R.length; ++i) {
	  	if (CATALOG_K1R[i].sku == currentSKU){

/* create a new var with all info about the match sku */
  			let productAllDetails = CATALOG_K1R[i];
...
/* render new html about the single product */
  		...
  		anotherProduct.id = 'goods_details_k1r';
  		let placeHere = document.getElementById('spinner_k1r');
		placeHere.append(anotherProduct);
		document.getElementById('goods_details_k1r').innerHTML =
			`
<div id='${sku}' class='sku'>
		...
		<div>
			...
			<!-- fabric buttons -->
				<div class='slide-fabric-nav' onClick ='event.stopPropagation()'>  	  
			    	<img class='slide-fabric-button fabric-var' id='${category}_JAZZ_01' src="http://decona.ru/wp-content/uploads/goods_pics/FABRIC/JAZZ/ICONS/JAZZ_01.png" onClick ='showDetailsByFabric_arm(event);'>
				
			    	<img class='slide-fabric-button fabric-var' id='${category}_JAZZ_21' src='http://decona.ru/wp-content/uploads/goods_pics/FABRIC/JAZZ/ICONS/JAZZ_21.png' onClick ='showDetailsByFabric_arm(event);'>
			    
			    	<img class='slide-fabric-button fabric-var' id='${category}_PIXEL_FOREST' src= "http://decona.ru/wp-content/uploads/goods_pics/FABRIC/PIXEL/ICONS/PIXEL_FOREST.png" onClick ='showDetailsByFabric_arm(event);'>
			    
			    	<img class='slide-fabric-button fabric-var' id='${category}_CAMBRIDGE_600' src="http://decona.ru/wp-content/uploads/goods_pics/FABRIC/CAMBRIDGE/ICONS/CAMBRIDGE_600.png" onClick ='showDetailsByFabric_arm(event);'>
			    
				    <img class='slide-fabric-button fabric-var' id='${category}_VELUTTO_32' src="http://decona.ru/wp-content/uploads/goods_pics/FABRIC/JAZZ/ICONS/JAZZ_08.png" onClick ='showDetailsByFabric_arm(event);'>
				</div>
				<div class='ms-4'>
	...
	<div class='container-fluid mt-5 d-block d-md-none'>
		...
		<div class='slide-fabric-nav' onClick ='event.stopPropagation()'>  	  
	    	<img class='slide-fabric-button fabric-var' id='${category}_JAZZ_01' src="http://decona.ru/wp-content/uploads/goods_pics/FABRIC/JAZZ/ICONS/JAZZ_01.png" onClick ='showDetailsByFabric_k1r(event);'>
				
	    	<img class='slide-fabric-button fabric-var' id='${category}_JAZZ_21' src='http://decona.ru/wp-content/uploads/goods_pics/FABRIC/JAZZ/ICONS/JAZZ_21.png' onClick ='showDetailsByFabric_k1r(event);'>
	    
	    	<img class='slide-fabric-button fabric-var' id='${category}_PIXEL_FOREST' src= "http://decona.ru/wp-content/uploads/goods_pics/FABRIC/PIXEL/ICONS/PIXEL_FOREST.png" onClick ='showDetailsByFabric_k1r(event);'>
	    
	    	<img class='slide-fabric-button fabric-var' id='${category}_CAMBRIDGE_600' src="http://decona.ru/wp-content/uploads/goods_pics/FABRIC/CAMBRIDGE/ICONS/CAMBRIDGE_600.png" onClick ='showDetailsByFabric_k1r(event);'>
	    
		    <img class='slide-fabric-button fabric-var' id='${category}_VELUTTO_32' src="http://decona.ru/wp-content/uploads/goods_pics/FABRIC/JAZZ/ICONS/JAZZ_08.png" onClick ='showDetailsByFabric_k1r(event);'>	
		</div>
	...
	<div class='mb-4 px-5 latte_bg banner container-fluid d-none d-md-block d-lg-block d-xl-block d-xxl-block'>
		<div class="d-flex justify-content-evenly">
			...
			<div class='mt-1'>
				<p class='prod-card-price'>${price_sale}</p>
