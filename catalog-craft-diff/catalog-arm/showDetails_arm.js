...
function showDetails_arm(event){
...
/* compare the clicked SKU with all SKUs in [] */
   	for (let i = 0; i < CATALOG_ARM.length; ++i) {		
		if (CATALOG[i].sku == currentSKU){

/* create a new var with all info about the match sku */
  			let productAllDetails = CATALOG_ARM[i];
  			console.log(productAllDetails);

/* remove current html */
  			var allProducts = document.getElementById('goods_show_arm');
  			allProducts.remove();
...
/* render new html about the single product */
  			document.getElementById('goods_details_arm').innerHTML = 
			`
<div id='${sku}' class='sku'>
	<!-- Desctop -->
	<div class='container-fluid mt-4 d-none d-md-block d-lg-block d-xl-block d-xxl-block'>
		<div class='thin ms-4'><a href='http://decona.ru/products/'>Продукция</a> / <a href='http://decona.ru/category-armchair/'>Кресла</a>
		</div>
	...
	<div class='mb-4 px-5 latte_bg banner container-fluid d-none d-md-block d-lg-block d-xl-block d-xxl-block'>
		<div class="d-flex justify-content-evenly">
			...
			<div class="mt-3 d-flex justify-content-between">
				<a class='' href='#'>
					<button class='to-order white btn-prod-card' onClick='pushSKUinForm_arm(event);'>
						Заказать
					</button>
				</a>
				<a class='white' href='#'>
	...
	<div class=' mt-2 d-block d-md-none'>
		...
		<div class="d-flex justify-content-around white btn-prod-card my-2 img-cover">
				<a class='to-order white p-2' onClick='pushSKUinForm_arm(event);'>
					Заказать
				</a>
